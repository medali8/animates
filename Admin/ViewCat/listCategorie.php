                ...
                <table>
                    ...
                    <?php
                        ...
                        <tr style="font-weight:bold;">
                           ...
                           <td><a href="index.php?controller=categorie&action=modif1&id=<?= $c->id_cat ;?>" style="color : black;"><i class="bi bi-pen"></i></a></td>
                           <td><a href="index.php?controller=categorie&action=supprimer&id=<?= $c->id_cat ;?>" style="color : black;"><i class="bi bi-trash"></i></a></td>
                            </tr>
