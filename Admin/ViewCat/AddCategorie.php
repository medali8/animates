        ...
        <div class="row ">
            ...
            <div class="col-10">
                <div class="rightside">
                    <div class="singin">
                        <br><br>
                        <h1 class="text-start mx-5" style="color:white">Add Categorie</h1>
                        <br><br><br><br><br>
                        <form class="text-center" action="index.php?controller=categorie&action=ajout2" method=POST>
                            <label for="un"> Nom Categorie </label><br>
