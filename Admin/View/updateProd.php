            ...
            <div class="col-10">
                <div class="rightside">
                    <div class="singin">
                        ...
                        <br>
                        <form class="text-center" method=POST action="index.php?controller=product&action=modif2&id="<?= $_REQUEST["id"] ;?>>
                            <label for="un"> libelle product </label><br>
                            <input type="text" name="lp" id="lp" value=<?= $p->lib_prod ?>>
                            <br>
                            
                            <input type="hidden" name="id" id="id" value=<?= $p->id_prod ?>>
                            
                            <label for="un"> Price product </label><br>
                            <input type="text" name="pp" id="pp" required="" value=<?= $p->prix ?>>
                            <br>
                            <label for="un"> Quantite stock </label><br>
                            <input type="text" name="qs" id="qs" required="" value=<?= $p->qte_stock ?>>
                            <br>
                            <label for="un"> Url picture </label><br>
                            <input type="text" name="up" id="up" required="" value=<?= $p->url_pic ?>>
                            <br>
                            <label for="un"> Categorie</label><br>
                            <select name="cat"  name="cat" style="width: 200px;height: 35px;color: #fff;background: #0000006b;outline: none;border: none;border-radius: 15px;">
