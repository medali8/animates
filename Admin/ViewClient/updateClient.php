            ...
            <div class="col-10">
                <div class="rightside">
                    <div class="singin">
                        ...
                        <br>
                        <form class="text-center" method=POST action="index.php?controller=clients&action=modif2&id="<?= $_REQUEST["id"] ;?>>
                            
                            <label for="un"> Nom </label><br>
                            <input type="text" name="nom" id="nom" value=<?= $c->nom ?>><br>
                            <label for="un">Prenom  </label><br>
                            <input type="text" name="pren" id="pren" value=<?= $c->prenom ?>><br>
                            <label for="un">Adresse</label><br>
                            <input type="text" name="add" id="add" value=<?= $c->adresse ?>><br>
                            <label for="un">Adresse-mail</label><br>
                            <input type="text" name="mail" id="mail" value=<?= $c->email ?>><br>
                            <label for="un"> Num tel</label><br>
                            <input type="text" name="nt" id="nt" value=<?= $c->numtel?>><br>
                            <br>
                            <input type="hidden" name="cin" id="cin" value=<?= $c->cin ?>><br>
