                ...
                <table>
                    ...
                    <?php
                        ...
                        <tr style="font-weight:bold;">
                           ...
                           <td><a href="index.php?controller=commande&action=modif1&id=<?= $cmd->id_cmd ;?>" style="color : black;"><i class="bi bi-pen"></i></a></td>
                           <td><a href="index.php?controller=commande&action=supprimer&id=<?= $cmd->id_cmd;?>" style="color : black;"><i class="bi bi-trash"></i></a></td>
                            </tr>
